...
# ============================================================
# Fig D5: Precision-Recall 对比 — 带差异标注
# ============================================================
def fig_d5_precision_recall():
    ...
    # 绘制 Precision-Recall 差异 — 置于柱状图顶部数值上方
    for i in range(5):
...
# ============================================================
# Fig D6: F1 性能步进图 (重设计 — 绝对 F1 + 增量标注)
# ============================================================
...
# ============================================================
# Fig D9 (新增): 模型规模-性能气泡图
# ============================================================
def fig_d9_model_size():
    fig, ax = plt.subplots(figsize=(8.0, 4.8))
    params = [0.0, 2.0, 110, 7000, 7000 + 3.4]  # 百万
