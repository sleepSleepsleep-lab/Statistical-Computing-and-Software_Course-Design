"""
01_svm.py
优化：max_features 提升至 10000，充分利用 9.6k+1.2k 文本的丰富词汇。
"""
import time
import pandas as pd
import jieba
...
if __name__ == "__main__":
    print("加载数据与分词中...")
    train_df, dev_df, test_df = load_and_cut(CONFIG["train_path"]), load_and_cut(CONFIG["dev_path"]), load_and_cut(CONFIG["test_path"])
